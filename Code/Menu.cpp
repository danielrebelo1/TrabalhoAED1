...
void Menu::MainMenu() {
    ...
    cout << "1.Ver informações de um estudante" << '\t' << "2.Consultar turmas" << '\t' << "3.Consultar horários" << '\t'<< "4.Pedidos de alteração" << '\t' << "5.Sair" << '\n';
    char option;
    cin >> option;
        ...
        case '1':
            caso1:
                ...
                if (it == studentsSet.end()){cout << "Estudante não existente na base de dados.Tente novamente ou carregue 'q' para voltar atrás"<< endl;
                    ...
                    cout << "Nome estudante : " << setw(20) << s->get_Name() << "\t" << "Número de estudante: " << setw(10) << s->get_student_Code() << endl;
